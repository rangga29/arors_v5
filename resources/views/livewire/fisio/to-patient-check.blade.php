...
<main class="background">
    ...
    <div class="reg-card">
        <div class="reg-header">
            ...
            <h2>REGISTRASI PASIEN TERAPI OKUPASI</h2>
            <span class="reg-badge">Form Registrasi</span>
        </div>

        <p class="reg-description">
            Form Registrasi Digunakan Untuk Pasien Yang Ingin Mendaftar ke Terapi Okupasi
        </p>
        ...
        @if ($isOpen)
            <div class="reg-form-group">
                ...
                <select class="reg-select" wire:model.live="patientStatus" required>
                    ...
                    <option value="UMUM PAGI">Pasien Okupasi - Umum Pagi</option>
                    <option value="UMUM SORE">Pasien Okupasi - Umum Sore</option>
                    <option value="ASURANSI PAGI">Pasien Okupasi - Asuransi Pagi</option>
                    <option value="ASURANSI SORE">Pasien Okupasi - Asuransi Sore</option>
                    <option value="BPJS PAGI">Pasien Okupasi - BPJS Pagi</option>
                    <option value="BPJS SORE">Pasien Okupasi - BPJS Sore</option>
                </select>
            </div>

            @if ($patientStatus == 'UMUM PAGI' || $patientStatus == 'UMUM SORE')
                <form wire:submit.prevent="createAppointmentUmum">
                    <div class="reg-section-title">
                        <i class="ri-file-list-3-line"></i> Data Pasien Umum
                    </div>
            ...
            @elseif($patientStatus == 'ASURANSI PAGI' || $patientStatus == 'ASURANSI SORE')
                <form wire:submit.prevent="createAppointmentAsuransi">
                    <div class="reg-section-title">
                        <i class="ri-file-list-3-line"></i> Data Pasien Asuransi
                    </div>
            ...
            @elseif($patientStatus == 'BPJS PAGI' || $patientStatus == 'BPJS SORE')
                <div class="reg-announcement reg-announcement-warning">
                    <div class="reg-announcement-content">
                ...
                <form wire:submit.prevent="createAppointmentBpjs">
                    <div class="reg-section-title">
                        <i class="ri-file-list-3-line"></i> Data Pasien BPJS
                    </div>
