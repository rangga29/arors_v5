...
class TOPatientCheck extends Component
{
    ...
    {
        View::share('type', 'terapi-okupasi');
        return view('livewire.fisio.to-patient-check', [
            ...
            'subTitle' => 'Form Pasien Terapi Okupasi',
            'description' => 'Form Registrasi Online Rumah Sakit Cahya Kawaluyan untuk Pasien Terapi Okupasi',
            'subKeywords' => 'form pasien terapi okupasi, form pasien'
        ]);
    }
    ...
    public function createAppointmentUmum()
    {
        ...
        if ($scheduleData['sc_available'] == 0 || $scheduleDetailData['scd_available'] == 0) {
            return redirect()->route('terapi-okupasi')->with('error', 'Mohon Maaf Jadwal [' . $scheduleData['sc_clinic_name'] . ' -- ' . $scheduleData['sc_doctor_name'] . '] Tidak Tersedia');
        }
        ...
        if ($scheduleDetailData['scd_counter_online_umum'] === $scheduleDetailData['scd_online_umum']) {
            if ($scheduleDetailData['scd_counter_online_bpjs'] === $scheduleDetailData['scd_online_bpjs']) {
                return redirect()->route('terapi-okupasi')->with('error', 'Mohon Maaf Kuota Online Pasien Terapi Okupasi [' . $scheduleData['sc_clinic_name'] . ' -- ' . $scheduleData['sc_doctor_name'] . '] Sudah Penuh. Silahkan Datang Langsung Ke Rumah Sakit Untuk Registrasi Langsung.');
            }
        }
                        ...
                        try {
                            ...
                            if ($responseApp->getStatusCode() == 200) {
                                ...
                                if ($dataApp['Status'] == 'SUCCESS (000)') {
                                    ...
                                    return redirect()->route('terapi-okupasi.umum.final', $dataFieldApp['AppointmentID'])->with('success', 'Registrasi Berhasil Dilakukan');
                                } else {
                                    return redirect()->route('terapi-okupasi')->with('error', $dataApp['Status'] . ' - ' . $dataApp['Remarks']);
                                }
                            } else {
                                return redirect()->route('terapi-okupasi')->with('error', 'Mohon Maaf Terjadi Kesalahan Pada Sistem. Silahkan Menghubungi Customer Service di 0812 1111 8009. Terima Kasih. [' . $responseApp->getStatusCode() . ']');
                            }
                        } catch (RequestException $e) {
                            return redirect()->route('terapi-okupasi')->with('error', 'Mohon Maaf Terjadi Kesalahan Pada Sistem. Silahkan Menghubungi Customer Service di 0812 1111 8009. Terima Kasih. [500] - 2');
                        }
                    } else {
                        ...
                        try {
                            ...
                            if ($responseApp->getStatusCode() == 200) {
                                ...
                                if ($dataApp['Status'] == 'SUCCESS (000)') {
                                    ...
                                    return redirect()->route('terapi-okupasi.asuransi.final', $dataFieldApp['AppointmentID'])->with('success', 'Registrasi Berhasil Dilakukan');
                                } else {
                                    return redirect()->route('terapi-okupasi')->with('error', $dataApp['Status'] . ' - ' . $dataApp['Remarks']);
                                }
                            } else {
                        ...
                        try {
                            ...
                            if ($responseApp->getStatusCode() == 200) {
                                ...
                                if ($dataApp['Status'] == 'SUCCESS (000)') {
                                    ...
                                    return redirect()->route('terapi-okupasi.bpjs.final', $dataFieldApp['AppointmentID'])->with('success', 'Registrasi Berhasil Dilakukan');
                                } else {
                                    return redirect()->route('terapi-okupasi')->with('error', $dataApp['Status'] . ' - ' . $dataApp['Remarks']);
                                }
                            } else {
