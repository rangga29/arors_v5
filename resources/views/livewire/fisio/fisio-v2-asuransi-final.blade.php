<main class="background">
    <div class="receipt-card">
        <div class="receipt-header">
            ...
            <h2>REGISTRASI FISIOTERAPI ASURANSI / KONTRAKTOR</h2>
        ...
        <div class="data-row">
            <span class="data-label">Nama Petugas</span>
        ...
        <div class="receipt-notes">
            <p>* Untuk Konfirmasi Kepastian Jadwal Praktek Petugas / Terdapat Pertanyaan Dapat Menghubungi Customer
