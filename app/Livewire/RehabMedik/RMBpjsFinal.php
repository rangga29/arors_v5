...
class RMBpjsFinal extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.rehab-medik.rehab-bpjs-final')
            ->layout('frontend.layout', [
                'subTitle' => 'Form Final Pasien Rehab Medik BPJS',
                'description' => 'Form Final Registrasi Online Rumah Sakit Cahya Kawaluyan untuk Pasien Rehab Medik BPJS',
                'subKeywords' => 'form pasien rehab medik bpjs, form pasien'
            ]);
    }
    ...
    {
        $fileName = Carbon::createFromFormat('Y-m-d', $this->scheduleDateData['sd_date'])->format('Ymd') . '_' . $this->appointmentDetailData['uap_norm'] . '_BuktiRegolRehabMedikBpjsRSCK';
        $data = [
            'title' => $fileName,
        ...
        $pdf = PDF::loadView('frontend.rehab-bpjs-print', $data);
