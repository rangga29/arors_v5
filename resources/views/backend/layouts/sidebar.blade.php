    ...
    <div class="h-100" id="leftside-menu-container" data-simplebar>
        <div class="leftbar-user">
            <a href="{{ route('second', ['pages', 'profile']) }}">
                <img src="{{ asset('images/rsck_logo.png') }}" alt="user-image" height="42"
        ...
        <ul class="side-nav">
            ...
            @can('view appointments')
                <li class="side-nav-item">
                    <a href="{{ route('second', ['appointments', \Carbon\Carbon::today()->format('Y-m-d')]) }}"
                        class="side-nav-link">
                ...
                <li class="side-nav-item">
                    ...
                    <div class="collapse" id="sidebarSchedule">
                        <ul class="side-nav-second-level">
                            ...
                            <li>
                                <a href="{{ route('second', ['schedules', \Carbon\Carbon::today()->format('Y-m-d')]) }}">Data
                                    Jadwal</a>
                            </li>
                        </ul>
                    </div>
            ...
            @can('view users')
                ...
                <li class="side-nav-item">
                    <a href="{{ route('any', ['data-migration']) }}" class="side-nav-link">
