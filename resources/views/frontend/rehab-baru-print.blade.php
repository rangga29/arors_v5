...
<body>
    ...
    <div class="print-header">
        ...
        <h1>REGISTRASI KLINIK REHABILITASI MEDIK PASIEN BARU
            {{ $appointmentDetailData['nap_business_partner_code'] == 'PERSONAL' ? 'UMUM' : 'ASURANSI' }}</h1>
    ...
    <table class="data-table">
        <tr>
            <td class="dt-label">NIK</td>
            <td class="dt-sep">:</td>
            <td class="dt-value">{{ $appointmentDetailData['nap_ssn'] }}</td>
        </tr>
        <tr>
            <td class="dt-label">Nama Pasien</td>
            <td class="dt-sep">:</td>
            <td class="dt-value">{{ $appointmentDetailData['nap_name'] }}</td>
        </tr>
        <tr>
            <td class="dt-label">Tanggal Lahir</td>
            <td class="dt-sep">:</td>
            <td class="dt-value">
                {{ \Carbon\Carbon::createFromFormat('Y-m-d', $appointmentDetailData['nap_birthday'])->isoFormat('DD MMMM YYYY') }}
            </td>
        </tr>
        <tr>
            <td class="dt-label">Alamat</td>
            <td class="dt-sep">:</td>
            <td class="dt-value">{{ $appointmentDetailData['nap_address'] }}</td>
        </tr>
        <tr>
            <td class="dt-label">Email</td>
            <td class="dt-sep">:</td>
            <td class="dt-value">{{ $appointmentDetailData['nap_email'] }}</td>
        </tr>
        <tr>
            <td class="dt-label">No. Handphone</td>
            <td class="dt-sep">:</td>
            <td class="dt-value">{{ $appointmentDetailData['nap_phone'] }}</td>
        </tr>
    </table>
    ...
    <table class="data-table">
        ...
        <tr>
            <td class="dt-label">Nama Dokter</td>
            <td class="dt-sep">:</td>
        ...
        @if ($appointmentDetailData['nap_business_partner_code'] != 'PERSONAL')
            <tr>
                <td class="dt-label">Nama Asuransi</td>
                <td class="dt-sep">:</td>
                <td class="dt-value">{{ $appointmentDetailData['nap_business_partner_name'] }}</td>
            </tr>
        @endif
    </table>
    <div class="notes-box">
        <div class="notes-title">Catatan Penting</div>
        <p>* Untuk konfirmasi kepastian jadwal praktek dokter / terdapat pertanyaan dapat menghubungi Customer Service
