...
<head>
    ...
    <style>
        ...
        * {
        ...
        /* Highlight box for important data */
        .highlight-box {
            display: flex;
...
<body>
    ...
    <div class="print-header">
        ...
        <h1>REGISTRASI PASIEN ASURANSI / KONTRAKTOR</h1>
    ...
    <table class="data-table">
        <tr>
            ...
            <td class="dt-sep">:</td>
            <td class="dt-value">{{ $appointmentDetailData['aap_norm'] }}</td>
        </tr>
        <tr>
            <td class="dt-label">Nama Pasien</td>
            <td class="dt-sep">:</td>
            <td class="dt-value">{{ $appointmentDetailData['aap_name'] }}</td>
        </tr>
        <tr>
            <td class="dt-label">Tanggal Lahir</td>
            <td class="dt-sep">:</td>
            <td class="dt-value">
                {{ \Carbon\Carbon::createFromFormat('Y-m-d', $appointmentDetailData['aap_birthday'])->isoFormat('DD MMMM YYYY') }}
            </td>
        </tr>
        <tr>
            <td class="dt-label">No. Handphone</td>
            <td class="dt-sep">:</td>
            <td class="dt-value">{{ $appointmentDetailData['aap_phone'] }}</td>
        </tr>
    </table>
    ...
    <table class="data-table">
        ...
        <tr>
            ...
            <td class="dt-sep">:</td>
            <td class="dt-value">{{ $appointmentDetailData['aap_business_partner_name'] }}</td>
        </tr>
    </table>
    ...
    <div class="notes-box">
        ...
        <p>* Nomor Antrian ini <strong>TIDAK DAPAT</strong> digunakan untuk mendaftar sebagai Pasien BPJS
            <strong>KECUALI</strong> Pasien Klinik Rehabilitasi Medik.
        </p>
        <p>* Untuk konfirmasi kepastian jadwal praktek dokter / terdapat pertanyaan dapat menghubungi Customer
            Service di nomor WhatsApp <strong>0812 1111 8009</strong>.</p>
    </div>
