...
<div class="content-container">
    ...
    <h2 class="title">REGISTRASI KLINIK REHABILITASI MEDIK UMUM</h2>
...
<div class="container">
    <div class="row">
        ...
        <div class="items">
            <p><strong>NORM : </strong>{{ $appointmentDetailData['uap_norm'] }}</p>
        </div>
        <div class="items">
            <p><strong>NAMA PASIEN : </strong>{{ $appointmentDetailData['uap_name'] }}</p>
        </div>
        <div class="items">
            <p><strong>TANGGAL LAHIR : </strong>{{ \Carbon\Carbon::createFromFormat('Y-m-d', $appointmentDetailData['uap_birthday'])->isoFormat('DD MMMM YYYY') }}</p>
        </div>
        <div class="items">
            <p><strong>NO. HANDPHONE : </strong>{{ $appointmentDetailData['uap_phone'] }}</p>
        </div>
        <div class="items">
        ...
        <div class="items">
            <p><strong>SESI : SESI </strong>{{ $scheduleDetailData['scd_session'] }}</p>
        </div>
        <div class="items">
        ...
        <hr>
        <p style="font-size: 16px;">Silahkan melakukan registrasi ulang secara mandiri pada Anjungan Pendaftaran Mandiri di depan pintu Klinik Kamilus</p>
