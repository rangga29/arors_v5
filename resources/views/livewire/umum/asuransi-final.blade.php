<main class="background">
    <div class="receipt-card">
        ...
        <div class="data-row">
            ...
            <span class="data-value text-uppercase">{{ $appointmentDetailData['aap_business_partner_name'] }}</span>
        </div>
        <div class="data-row">
        ...
        <div class="receipt-actions">
            <button class="w-100 btn btn-primary mb-2 text-uppercase" wire:click="downloadPdf"
