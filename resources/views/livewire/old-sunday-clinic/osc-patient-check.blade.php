...
<main class="background">
    ...
    <div class="pb-3 text-center">
        ...
        <h2>REGISTRASI PASIEN SUNDAY CLINIC</h2>
        <p class="lead fs-5">Form Registrasi Digunakan Untuk Khusus Untuk Pasien Sunday Clinic Yang Sudah Memiliki Nomor Rekam Medis</p>
        @if(!$isOpen)
    ...
    @if($isOpen)
        ...
        @else
            @livewire('sunday-clinic.s-c-old-appointment', ['patientData' => $patientData])
        @endif
    @endif
</main>
