...
class TOUmumFinal extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.fisio.to-umum-final')
            ->layout('frontend.layout', [
                'subTitle' => 'Form Final Pasien Terapi Okupasi Umum',
                'description' => 'Form Final Registrasi Online Rumah Sakit Cahya Kawaluyan untuk Pasien Terapi Okupasi Umum',
                'subKeywords' => 'form pasien terapi okupasi umum, form pasien'
            ]);
    }
    ...
    {
        $fileName = Carbon::createFromFormat('Y-m-d', $this->scheduleDateData['sd_date'])->format('Ymd') . '_' . $this->appointmentDetailData['uap_norm'] . '_BuktiRegolTerapiOkupasiUmumRSCK';
        ...
        $pdf = PDF::loadView('frontend.to-umum-print', $data);
