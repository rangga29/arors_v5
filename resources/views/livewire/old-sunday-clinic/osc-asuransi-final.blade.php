<main class="background">
    <div class="receipt-card">
        <div class="receipt-header">
            ...
            <h2>REGISTRASI PASIEN SUNDAY CLINIC ASURANSI / KONTRAKTOR</h2>
        ...
        <div class="data-row">
            ...
            <span class="data-value">{{ $appointmentDetailData['aap_norm'] }}</span>
        </div>
        <div class="data-row">
            <span class="data-label">Nama Pasien</span>
            <span class="data-value">{{ $appointmentDetailData['aap_name'] }}</span>
        </div>
        <div class="data-row">
        ...
        <div class="data-row">
            ...
            <span class="data-value">{{ $appointmentDetailData['aap_business_partner_name'] }}</span>
        </div>
        <div class="data-row">
