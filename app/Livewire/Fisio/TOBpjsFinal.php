...
class TOBpjsFinal extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.fisio.to-bpjs-final')
            ->layout('frontend.layout', [
                'subTitle' => 'Form Final Pasien Terapi Okupasi BPJS',
                'description' => 'Form Final Registrasi Online Rumah Sakit Cahya Kawaluyan untuk Pasien Terapi Okupasi BPJS',
                'subKeywords' => 'form pasien terapi okupasi bpjs, form pasien'
            ]);
    }
    ...
    {
        $fileName = Carbon::createFromFormat('Y-m-d', $this->scheduleDateData['sd_date'])->format('Ymd') . '_' . $this->appointmentDetailData['bap_norm'] . '_BuktiRegolTerapiOkupasiBpjsRSCK';
        $data = [
            'title' => $fileName,
        ...
        $pdf = PDF::loadView('frontend.to-bpjs-print', $data);
