...
<main class="background">
    ...
    <div class="reg-card">
        <div class="reg-header">
            ...
            <h2>REGISTRASI PASIEN TERAPI WICARA</h2>
            <span class="reg-badge">Form Registrasi</span>
        </div>

        <p class="reg-description">
            Form Registrasi Digunakan Untuk Pasien Yang Ingin Mendaftar ke Terapi Wicara
        </p>
        ...
        @if ($isOpen)
            <div class="reg-form-group">
                ...
                <select class="reg-select" wire:model.live="patientStatus" required>
                    ...
                    <option value="UMUM PAGI">Pasien Wicara - Umum Pagi</option>
                    <option value="UMUM SORE">Pasien Wicara - Umum Sore</option>
                    <option value="ASURANSI PAGI">Pasien Wicara - Asuransi Pagi</option>
                    <option value="ASURANSI SORE">Pasien Wicara - Asuransi Sore</option>
                    <option value="BPJS PAGI">Pasien Wicara - BPJS Pagi</option>
                    <option value="BPJS SORE">Pasien Wicara - BPJS Sore</option>
                </select>
            </div>
