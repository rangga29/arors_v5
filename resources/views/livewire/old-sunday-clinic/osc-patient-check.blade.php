...
<main class="background">
    ...
    <div class="reg-card">
        <div class="reg-header">
            ...
            <h2>REGISTRASI PASIEN SUNDAY CLINIC UMUM / ASURANSI / KONTRAKTOR</h2>
            <span class="reg-badge">Form Registrasi</span>
        </div>

        <p class="reg-description">
            Form Registrasi Digunakan Untuk Khusus Untuk Pasien Sunday Clinic Umum / Asuransi /
            Kontraktor Yang Sudah Memiliki Nomor Rekam Medis
        </p>
        ...
        @if ($isOpen)
            ...
            @else
                @livewire('sunday-clinic.s-c-old-appointment', ['patientData' => $patientData, 'serviceType' => $serviceType])
            @endif
        @endif
    </div>
</main>
