    ...
    @if (!empty($appointmentList))
        @foreach ($appointmentList as $index => $appointment)
            @php
                ...
                if ($isFisio) {
                    if ($isBpjs) {
                        $headerTitle = 'REGISTRASI PASIEN FISIOTERAPI BPJS';
                    } elseif ($isAsuransi) {
                        $headerTitle = 'REGISTRASI PASIEN FISIOTERAPI ASURANSI / KONTRAKTOR';
                    } else {
                        $headerTitle = 'REGISTRASI PASIEN FISIOTERAPI UMUM';
                    }
                } elseif ($isRehabMedik) {
                    $headerTitle = 'REGISTRASI PASIEN KLINIK REHABILITASI MEDIK';
                } elseif ($isSundayClinic) {
                    if ($isAsuransi) {
                        $headerTitle = 'REGISTRASI PASIEN SUNDAY CLINIC ASURANSI / KONTRAKTOR';
                    } else {
                        $headerTitle = 'REGISTRASI PASIEN SUNDAY CLINIC UMUM';
                    }
                } else {
                    if ($isAsuransi) {
                        $headerTitle = 'REGISTRASI PASIEN ASURANSI / KONTRAKTOR';
                    } else {
                        $headerTitle = 'REGISTRASI PASIEN UMUM';
                    }
                }
