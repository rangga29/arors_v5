...
<body>
    ...
    <div class="print-header">
        ...
        <h1>REGISTRASI TERAPI OKUPASI UMUM</h1>
    ...
    <div class="notes-box">
        ...
        <p>* Silahkan melakukan registrasi ulang secara mandiri pada Anjungan Pendaftaran Mandiri (APM) di area
            Klinik Rehabilitasi Medik.</p>
