...
<main class="background">
    ...
    @if(!$isHaveAppointment)
        ...
        <a href="{{ route('cek-antrian.nik') }}" class="w-100 btn btn-one btn-lg mt-2 fw-bold">Cek Antrian Dengan NIK</a>
    @else
        @livewire('cek.show-cek-data', ['umumData' => $umumData, 'asuransiData' => $asuransiData, 'fisioterapiData' => $fisioterapiData, 'bpjsData' => $bpjsData])
    @endif
</main>
