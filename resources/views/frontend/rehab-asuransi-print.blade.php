...
<div class="content-container">
    ...
    <h2 class="title">REGISTRASI KLINIK REHABILITASI MEDIK ASURANSI / KONTRAKTOR</h2>
...
<div class="container">
    <div class="row">
        ...
        <div class="items">
            <p><strong>NORM : </strong>{{ $appointmentDetailData['aap_norm'] }}</p>
        </div>
        <div class="items">
            <p><strong>NAMA PASIEN : </strong>{{ $appointmentDetailData['aap_name'] }}</p>
        </div>
        <div class="items">
            <p><strong>TANGGAL LAHIR : </strong>{{ \Carbon\Carbon::createFromFormat('Y-m-d', $appointmentDetailData['aap_birthday'])->isoFormat('DD MMMM YYYY') }}</p>
        </div>
        <div class="items">
            <p><strong>NO. HANDPHONE : </strong>{{ $appointmentDetailData['aap_phone'] }}</p>
        </div>
        <div class="items">
        ...
        <div class="items">
            <p><strong>NAMA ASURANSI : </strong>{{ $appointmentDetailData['aap_business_partner_name'] }}</p>
        </div>
        <div class="items">
