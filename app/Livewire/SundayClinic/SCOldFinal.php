...
class SCOldFinal extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.old-sunday-clinic.osc-final')
            ->layout('frontend.layout', [
                'subTitle' => 'Form Final Pasien Sunday Clinic Umum',
                'description' => 'Form Final Registrasi Online Rumah Sakit Cahya Kawaluyan untuk Pasien Sunday Clinic Umum',
    ...
    {
        $fileName = Carbon::createFromFormat('Y-m-d', $this->scheduleDateData['sd_date'])->format('Ymd') . '_' . $this->appointmentDetailData['uap_norm'] . '_BuktiRegolSundayClinicUmumRSCK';
        $data = [
            'title' => $fileName,
