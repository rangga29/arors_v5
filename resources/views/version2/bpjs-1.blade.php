    ...
    <div class="container">
        <div class="background">
            <div class="logo-container">
                ...
                <h2 class="logo-title">REGISTRASI PASIEN BPJS</h2>
                <p class="logo-text">Form Registrasi Digunakan Untuk Pasien BPJS Yang Sudah Memiliki Nomor Rekam Medis (NORM)</p>
                @if(!$isOpen)
            ...
            <form action="{{ route('old-bpjs.patient-check') }}" method="POST" role="form">
                @csrf
                ...
                <div class="form-group">
                    <label for="ppk1" class="form-label control-label">No Rujukan PPK 1</label>
                    <input type="text" class="form-control form-control-lg shadow border-0" name="ppk1" id="ppk1" placeholder="No Rujukan PPK 1" maxlength="19" autocomplete required>
                </div>
