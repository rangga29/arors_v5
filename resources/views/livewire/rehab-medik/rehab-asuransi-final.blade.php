<main class="background">
    <div class="text-center">
        ...
        <h2>REGISTRASI KLINIK REHABILITASI MEDIK ASURANSI / KONTRAKTOR</h2>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-12 mb-1">
                ...
                <p class="ms-2"><i class="ri-arrow-right-double-line"></i> {{ $appointmentDetailData['aap_norm'] }}</p>
            </div>
            <div class="col-12 mb-1">
                <p class="mb-0"><strong>NAMA PASIEN</strong></p>
                <p class="ms-2"><i class="ri-arrow-right-double-line"></i> {{ $appointmentDetailData['aap_name'] }}</p>
            </div>
            <div class="col-12 mb-1">
            ...
            <div class="col-12 mb-1">
                ...
                <p class="ms-2 text-uppercase"><i class="ri-arrow-right-double-line"></i> {{ $appointmentDetailData['aap_business_partner_name'] }}</p>
            </div>
            <div class="col-12 mb-1">
