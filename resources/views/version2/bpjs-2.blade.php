...
@section('content')
    <div class="container">
        <div class="background">
            ...
            <form action="{{ route('old-bpjs.appointment-store', $patient['pt_ucode']) }}" method="POST" role="form">
                @csrf
                ...
                <div class="form-group">
                    <label for="no_bpjs" class="form-label control-label">No Kartu BPJS</label>
                    <input type="text" class="form-control form-control-lg shadow border-0" name="no_bpjs" id="no_bpjs" value="{{ $patient['pt_bpjs'] }}" readonly>
                </div>
                <div class="form-group">
