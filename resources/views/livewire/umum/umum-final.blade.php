    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-12 mb-1">
                ...
                <p class="text-bg-warning text-dark" style="text-shadow: 0px 0px #ff0000;">
                    * Nomor Antrian Ini <span class="fw-bolder">TIDAK DAPAT</span> Digunakan Untuk Mendaftar Sebagai Pasien BPJS <span class="fw-bolder">KECUALI</span> Pasien Klinik Rehabilitasi Medik
                </p>
            </div>
            <div class="col-12 mb-1">
