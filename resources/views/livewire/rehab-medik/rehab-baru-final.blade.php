<main class="background">
    <div class="text-center">
        ...
        <h2>REGISTRASI KLINIK REHABILITASI MEDIK PASIEN BARU</h2>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-12 mb-1">
                ...
                <p class="ms-2"><i class="ri-arrow-right-double-line"></i> {{ $appointmentDetailData['nap_ssn'] }}</p>
            </div>
            <div class="col-12 mb-1">
                <p class="mb-0"><strong>NAMA PASIEN</strong></p>
                <p class="ms-2"><i class="ri-arrow-right-double-line"></i> {{ $appointmentDetailData['nap_name'] }}</p>
            </div>
            <div class="col-12 mb-1">
