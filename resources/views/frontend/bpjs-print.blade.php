...
<div class="content-container">
    ...
    <h2 class="title">REGISTRASI PASIEN BPJS</h2>
...
<div class="container">
    <div class="row">
        ...
        <div class="items">
            <p><strong>NORM : </strong>{{ $appointmentDetailData['bap_norm'] }}</p>
        </div>
        <div class="items">
            <p><strong>NAMA PASIEN : </strong>{{ $appointmentDetailData['bap_name'] }}</p>
        </div>
        <div class="items">
            <p><strong>NO BPJS : </strong>{{ $appointmentDetailData['bap_bpjs'] }}</p>
        </div>
        <div class="items">
            <p><strong>NO RUJUKAN : </strong>{{ $appointmentDetailData['bap_ppk1'] }}</p>
        </div>
        <div class="items">
            <p><strong>TANGGAL LAHIR : </strong>{{ \Carbon\Carbon::createFromFormat('Y-m-d', $appointmentDetailData['bap_birthday'])->isoFormat('DD MMMM YYYY') }}</p>
        </div>
        <div class="items">
            <p><strong>NO. HANDPHONE : </strong>{{ $appointmentDetailData['bap_phone'] }}</p>
        </div>
        <div class="items">
