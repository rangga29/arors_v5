...
<main class="background">
    ...
    <div class="reg-card">
        ...
        <p class="reg-description">
            Form Registrasi Digunakan Untuk Pasien Yang Ingin Mendaftar ke Fisioterapi
        </p>
        ...
        @if ($isOpen)
            <div class="reg-form-group">
                ...
                <select class="reg-select" wire:model.live="patientStatus" required>
                    ...
                    <option value="ASURANSI PAGI">Pasien Fisioterapi - Asuransi Pagi</option>
                    <option value="ASURANSI SORE">Pasien Fisioterapi - Asuransi Sore</option>
            ...
            @if ($patientStatus == 'UMUM PAGI' || $patientStatus == 'UMUM SORE')
                <form wire:submit.prevent="createAppointmentUmum">
                    ...
                    @if ($selectedClinic && $doctors->isNotEmpty())
                        <div class="reg-form-group">
                            <label for="selectedDoctor" class="reg-label">Petugas</label>
