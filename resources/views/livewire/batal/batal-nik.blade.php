    ...
    @if (!$isHaveAppointment)
        <div class="reg-card">
            <div class="reg-header">
                ...
                <span class="reg-badge">Cari Dengan NIK</span>
            </div>
            ...
            <a href="{{ route('batal-antrian.norm') }}" class="reg-submit-btn"
                ...
                <i class="ri-file-list-3-line"></i> Pembatalan Antrian Dengan NORM
            </a>
        </div>
    @else
        @livewire('batal.show-batal-nik', ['newData' => $newData])
    @endif
</main>
