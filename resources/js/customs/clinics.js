$(document).on('click', '.cl-edit', function () {
    ...
    $.ajax({
        ...
        success: function (clinic) {
            ...
            if (clinic.cl_department === 'OUTPATIENT') {
                $('#edit_cl_department_1').prop('checked', true);
            } else {
                $('#edit_cl_department_2').prop('checked', true);
            }
            if (clinic.cl_visit_type === 'VT01') {
                $('#edit_cl_visit_type_1').prop('checked', true);
            } else {
                $('#edit_cl_visit_type_2').prop('checked', true);
            }
