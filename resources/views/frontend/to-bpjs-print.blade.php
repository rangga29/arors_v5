...
<body>
    ...
    <div class="print-header">
        ...
        <h1>REGISTRASI TERAPI OKUPASI BPJS</h1>
    ...
    <table class="data-table">
        <tr>
            ...
            <td class="dt-sep">:</td>
            <td class="dt-value">{{ $appointmentDetailData['bap_norm'] }}</td>
        </tr>
        <tr>
            <td class="dt-label">Nama Pasien</td>
            <td class="dt-sep">:</td>
            <td class="dt-value">{{ $appointmentDetailData['bap_name'] }}</td>
        </tr>
        <tr>
            <td class="dt-label">Tanggal Lahir</td>
            <td class="dt-sep">:</td>
            <td class="dt-value">
                {{ \Carbon\Carbon::createFromFormat('Y-m-d', $appointmentDetailData['bap_birthday'])->isoFormat('DD MMMM YYYY') }}
            </td>
        </tr>
        <tr>
            <td class="dt-label">No. Handphone</td>
            <td class="dt-sep">:</td>
            <td class="dt-value">{{ $appointmentDetailData['bap_phone'] }}</td>
        </tr>
    </table>
