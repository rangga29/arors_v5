...
class TWBpjsFinal extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.fisio.tw-bpjs-final')
            ->layout('frontend.layout', [
                'subTitle' => 'Form Final Pasien Terapi Wicara BPJS',
                'description' => 'Form Final Registrasi Online Rumah Sakit Cahya Kawaluyan untuk Pasien Terapi Wicara BPJS',
                'subKeywords' => 'form pasien terapi wicara bpjs, form pasien'
            ]);
    }
    ...
    {
        $fileName = Carbon::createFromFormat('Y-m-d', $this->scheduleDateData['sd_date'])->format('Ymd') . '_' . $this->appointmentDetailData['bap_norm'] . '_BuktiRegolTerapiWicaraBpjsRSCK';
        $data = [
            'title' => $fileName,
        ...
        $pdf = PDF::loadView('frontend.tw-bpjs-print', $data);
