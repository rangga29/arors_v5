...
class BaruFinal extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.baru.baru-final')
            ->layout('frontend.layout', [
                'subTitle' => 'Form Final Pasien Baru',
                'description' => 'Form Final Registrasi Online Rumah Sakit Cahya Kawaluyan untuk Pasien Baru',
    ...
    {
        $fileName = Carbon::createFromFormat('Y-m-d', $this->scheduleDateData['sd_date'])->format('Ymd') . '_' . $this->appointmentDetailData['uap_norm'] . '_BuktiRegolPasienBaruRSCK';
        $data = [
            'title' => $fileName,
