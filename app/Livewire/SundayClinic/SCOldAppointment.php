        ...
        try {
            ...
            if ($response->getStatusCode() == 200) {
                ...
                if($data['Status'] == 'SUCCESS (000)') {
                    ...
                    return redirect()->route('sunday-clinic.old-patient.final', $dataField['AppointmentID'])->with('success', 'Registrasi Berhasil Dilakukan');
                } else {
                    return redirect()->route('sunday-clinic.old-patient')->with('error', $data['Status'] . ' - ' . $data['Remarks']);
                }
            } else {
