    ...
    <div class="container">
        <div class="background">
            <div class="logo-container">
                ...
                <h2 class="logo-title">REGISTRASI PASIEN UMUM</h2>
                <p class="logo-text">Form Registrasi Digunakan Untuk Pasien Umum Yang Sudah Memiliki Nomor Rekam Medis (NORM)</p>
            </div>

            <form action="{{ route('old-umum.appointment-store', $patient['pt_ucode']) }}" method="POST" role="form">
                @csrf
