...
class RMPatientCheck extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.rehab-medik.rehab-patient-check', [
            ...
            'subTitle' => 'Form Pasien Rehab Medik',
            'description' => 'Form Registrasi Online Rumah Sakit Cahya Kawaluyan untuk Pasien Rehab Medik ',
            'subKeywords' => 'form pasien rehab medik, form pasien'
        ]);
    }
            ...
            if ($responseBpjs->getStatusCode() == 200) {
                ...
                if ($dataBpjs['metaData']['code'] == 200) {
                    ...
                    if ($bpjs_result['peserta']['mr']['noMR']) {
                        ...
                        if ($this->patientStatus == 'baru-umum') {
                            $requestData = [
                                'HealthcareID' => '001',
                                'DepartmentID' => 'OUTPATIENT',
                                'AppointmentMethod' => '003',
                            ...
                            if ($responseApp->getStatusCode() == 200) {
                                ...
                                if ($dataApp['Status'] == 'SUCCESS (000)') {
                                    ...
                                    NewAppointment::create([
                                        ...
                                        'nap_business_partner_code' => $this->patientStatus == 'baru-umum' ? $requestData['BusinessPartnerCode'] : $businessPartnerData['bp_code'],
                                        'nap_business_partner_name' => $this->patientStatus == 'baru-umum' ? $requestData['BusinessPartnerCode'] : $businessPartnerData['bp_name']
                                    ]);
