...
class RMAsuransiFinal extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.rehab-medik.rehab-asuransi-final')
            ->layout('frontend.layout', [
                'subTitle' => 'Form Final Pasien Rehab Medik Asuransi / Kontraktor',
                'description' => 'Form Final Registrasi Online Rumah Sakit Cahya Kawaluyan untuk Pasien Rehab Medik Asuransi / Kontraktor',
                'subKeywords' => 'form pasien rehab medik asuransi kontraktor, form pasien'
            ]);
    }
    ...
    {
        $fileName = Carbon::createFromFormat('Y-m-d', $this->scheduleDateData['sd_date'])->format('Ymd') . '_' . $this->appointmentDetailData['aap_norm'] . '_BuktiRegolRehabMedikAsuransiRSCK';
        $data = [
            'title' => $fileName,
        ...
        $pdf = PDF::loadView('frontend.rehab-asuransi-print', $data);
