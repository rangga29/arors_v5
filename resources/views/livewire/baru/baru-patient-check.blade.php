...
<main class="background">
    ...
    <div class="reg-card">
        ...
        <p class="reg-description">
            Form Registrasi Digunakan Untuk Pasien Umum Yang Belum Pernah Berobat di RSCK.
        </p>
        ...
        @if ($isOpen)
            ...
            @else
                @livewire('baru.baru-appointment', ['patientData' => $patientData, 'serviceType' => $serviceType])
            @endif
        @endif
    </div>
</main>
