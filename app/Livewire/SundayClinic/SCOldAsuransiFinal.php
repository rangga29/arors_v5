...
class SCOldAsuransiFinal extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.old-sunday-clinic.osc-asuransi-final')
            ->layout('frontend.layout', [
                'subTitle' => 'Form Final Pasien Sunday Clinic Asuransi / Kontraktor',
                'description' => 'Form Final Registrasi Online Rumah Sakit Cahya Kawaluyan untuk Pasien Sunday Clinic Asuransi / Kontraktor',
    ...
    {
        $fileName = Carbon::createFromFormat('Y-m-d', $this->scheduleDateData['sd_date'])->format('Ymd') . '_' . $this->appointmentDetailData['aap_norm'] . '_BuktiRegolSundayClinicAsuransiRSCK';
        $data = [
            'title' => $fileName,
        ...
        $pdf = PDF::loadView('frontend.osc-asuransi-print', $data);
